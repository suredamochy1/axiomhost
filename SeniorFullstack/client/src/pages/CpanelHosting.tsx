...
export default function CpanelHosting() {
  const plans = hostingTypes["cpanel-hosting"].plans;
      ...
      <section className="pt-24 pb-16 px-6 max-w-7xl mx-auto">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-black mb-4">
            NH <span className="text-[#EC1C65]">cPanel Hosting</span>
          </h1>
          <p className="text-xl text-slate-400 mb-6 max-w-3xl mx-auto">
            Reliable hosting with easy-to-use cPanel control panel management. Perfect for websites, blogs, and small businesses.
          </p>
        </motion.div>
