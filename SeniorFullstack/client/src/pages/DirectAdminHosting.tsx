...
export default function DirectAdminHosting() {
  const plans = hostingTypes["direct-admin-hosting"].plans;
      ...
      <section className="pt-24 pb-16 px-6 max-w-7xl mx-auto">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-black mb-4">
            <span className="text-[#EC1C65]">Direct Admin Hosting</span>
          </h1>
          <p className="text-xl text-slate-400 mb-6 max-w-3xl mx-auto">
            Lightweight, fast, and feature-rich hosting solution with DirectAdmin control panel. Optimized for performance.
          </p>
        </motion.div>
