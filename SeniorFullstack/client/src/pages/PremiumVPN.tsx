...
export default function PremiumVPN() {
  const plans = hostingTypes["premium-vpn"].plans;
      ...
      <section className="pt-24 pb-16 px-6 max-w-7xl mx-auto">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-black mb-4">
            <span className="text-[#EC1C65]">Premium VPN Services</span>
          </h1>
          <p className="text-xl text-slate-400 mb-6 max-w-3xl mx-auto">
            Secure, fast, and private browsing with VPN access. Military-grade encryption for all your devices.
          </p>
        </motion.div>
