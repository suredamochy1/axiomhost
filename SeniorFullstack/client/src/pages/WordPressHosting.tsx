...
export default function WordPressHosting() {
  const plans = hostingTypes["wordpress"].plans;
      ...
      <section className="pt-24 pb-16 px-6 max-w-7xl mx-auto">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-black mb-4">
            NH <span className="text-[#EC1C65]">WordPress Hosting</span>
          </h1>
          <p className="text-xl text-slate-400 mb-6 max-w-3xl mx-auto">
            Optimized performance for WordPress websites. Pre-installed with auto-updates, daily backups, and 24/7 support.
          </p>
        </motion.div>
