...
export default function WebDevelopment() {
  const plans = hostingTypes["web-development"].plans;
      ...
      <section className="pt-24 pb-16 px-6 max-w-7xl mx-auto">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-black mb-4">
            <span className="text-[#EC1C65]">Web Development</span>
          </h1>
          <p className="text-xl text-slate-400 mb-6 max-w-3xl mx-auto">
            Custom websites built for your business needs. From startups to enterprises, we deliver beautiful, functional websites.
          </p>
        </motion.div>
