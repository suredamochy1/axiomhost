...
export default function ManagedHosting() {
  const plans = hostingTypes["managed-hosting"].plans;
      ...
      <section className="pt-24 pb-16 px-6 max-w-7xl mx-auto">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-black mb-4">
            <span className="text-[#EC1C65]">Managed Hosting</span>
          </h1>
          <p className="text-xl text-slate-400 mb-6 max-w-3xl mx-auto">
            Enterprise-grade hosting with dedicated support. Let us handle the technical side while you focus on your business.
          </p>
        </motion.div>
